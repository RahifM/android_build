...
KERNEL_TOOLCHAIN_ROOT ?= $(ANDROID_BUILD_TOP)/prebuilts/gcc/$(HOST_PREBUILT_TAG)/aarch64/aarch64-linux-android-$(KERNEL_GCC_VERSION)
KERNEL_TOOLCHAIN_PREFIX := $(KERNEL_TOOLCHAIN_ROOT)/bin/aarch64-linux-android-
endif #KERNEL_ARCH
endif # KERNEL_TOOLCHAIN_PREFIX
...
ifneq ($(KERNEL_TOOLCHAIN),)
KERNEL_TOOLCHAIN_PATH := $(KERNEL_TOOLCHAIN)/$(TARGET_KERNEL_CROSS_COMPILE_PREFIX)
else
...
else # TARGET_CUSTOM_TOOLCHAIN

TARGET_KERNEL_CROSS_COMPILE_PREFIX := $(strip $(TARGET_KERNEL_CROSS_COMPILE_PREFIX))
KERNEL_TOOLCHAIN_PREFIX ?= $(TARGET_KERNEL_CROSS_COMPILE_PREFIX)
KERNEL_TOOLCHAIN_PATH ?= $(KERNEL_TOOLCHAIN)/$(TARGET_KERNEL_CROSS_COMPILE_PREFIX)

endif # TARGET_CUSTOM_TOOLCHAIN != true
